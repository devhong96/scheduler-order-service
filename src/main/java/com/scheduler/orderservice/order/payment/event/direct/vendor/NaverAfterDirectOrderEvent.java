...
@Getter
public class NaverAfterDirectOrderEvent extends ApplicationEvent {
    ...
    public NaverAfterDirectOrderEvent(Object source, String studentId, String username, Integer quantity, OrderCategory orderCategory, NaverOrderResponse naverOrderResponse) {
        super(source);
