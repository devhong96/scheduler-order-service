...
public class NICEPayCreateCartOrder implements CreateOrderProcessor {
    ...
    public void process(String orderId, OrderType orderType, OrderCategory orderCategory, StudentResponse studentResponse,
        ...
        Orders orders = Orders.create(orderId, NICEPAY, paymentHistoryDto.getTid(), studentResponse);
